    ...
    <div className="mobile md:hidden ">
      <div className="items-center flex justify-center h-full">
        <button
          ...
          className="text-white items-center content-center"
        >
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-6 items-center content-center h-[100%]"
          >
            <path
              strokeLinecap="round"
      ...
      {isMobileMenuOpen && (
        <div className="flex flex-col gap-3 bg-[#152955] text-white p-4 mt-2 rounded-lg absolute left-[-150%] content-center items-center text-[12px]">
          ...
          {session ? (
            <button onClick={logout} className="border-[1px] rounded-md p-2">
              Logout
            </button>
          ) : (
            <Link href={'/login'}>
