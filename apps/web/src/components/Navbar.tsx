  ...
  return <>
      ...
      <div className=" bg-[#152955] text-white px-[40px] py-[16px]  text-sm">
        <div className="flex justify-between">
            <Link href={"/"}>
                <img src="https://assets.loket.com/images/logo-loket-white.png" alt="" className='h-8'/>
            </Link>
            ...
            <div className="flex gap-5">
                <div className="content-center flex items-center gap-1">
                    <img src="https://assets.loket.com/web/assets/img/ic_schedule.svg" alt="" className='w-[21px]'/>
                    <a href="">Buat Event</a>
                </div>
                <div className="content-center flex items-center gap-1">
                    <img src="	https://assets.loket.com/web/assets/img/ic_explore_compass.svg" alt="" className='w-[21px]' />
                    <a href="">Jelajah</a>
                </div>
